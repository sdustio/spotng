 ...
 */
class PeriodicPrintTaskStatus : public PeriodicTask {
 public:
  PeriodicPrintTaskStatus(PeriodicTaskManager* tm, std::chrono::nanoseconds period)
...
class PeriodicCallMemberFunction : public PeriodicTask {
 public:
  PeriodicCallMemberFunction(PeriodicTaskManager* taskManager, std::chrono::nanoseconds period,
