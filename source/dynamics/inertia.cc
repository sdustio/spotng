...
namespace sdrobot::dynamics
{
  ...
  bool SpatialRotation(Eigen::Ref<SpatialXform> ret, CoordinateAxis const axis, double const theta)
  {
    RotMat R;
  ...
  bool SpatialInertiaToMassProperties(Eigen::Ref<MassProperties> ret, Eigen::Ref<SpatialInertia const> const &si)
  {
    Vector3 h;
    math::MatToSkewVec(h, si.topRightCorner<3, 3>());
    ret << si(5, 5), h(0), h(1), h(2), si(0, 0), si(1, 1),
  ...
  bool JointXform(Eigen::Ref<Matrix6> ret, JointType const joint, CoordinateAxis const axis, double const q)
  {
    ret.setZero();
  ...
  bool MotionCrossProduct(Eigen::Ref<SpatialVec> ret, Eigen::Ref<Vector6 const> const &a, Eigen::Ref<Vector6 const> const &b)
  {
  ...
  bool ForceCrossProduct(Eigen::Ref<SpatialVec> ret, Eigen::Ref<Vector6 const> const &a, Eigen::Ref<Vector6 const> const &b)
  {
